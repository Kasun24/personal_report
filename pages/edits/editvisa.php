...
if (isset($_GET['vis_sml'])) {
    $vis_sml = $_GET['vis_sml'];
...
if (isset($_POST['Submit'])) {
    ...
    if (!isset($errorMsg)) {
        $sql = "update visa
				set vis_issD = '" . $vis_issD . "',
                vis_type = '" . $vis_type . "',
                vis_cntr = '" . $vis_cntr . "',
                vis_exD = '" . $vis_exD . "'   
					where vis_sml=" . $vis_sml;
        $result = mysqli_query($conn, $sql);
        if ($result) {
                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-description">Edit Visa Details</h4>
                                    <br>
                                    <form class="form-sample" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" value="<?php echo $row['vis_sml'] ?>" name="vis_sml" class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-6 col-form-label">Visa Issued Date</label>
                                                    <div class="col-sm-6">
                                                        <input type="text" value="<?php echo $row['vis_issD'] ?>" name="vis_issD" class="form-control"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" value="<?php echo $row['vis_type'] ?>" name="vis_type" class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" value="<?php echo $row['vis_cntr'] ?>" name="vis_cntr" class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-6 col-form-label">Visa Expire Date</label>
                                                    <div class="col-sm-6">
                                                        <input type="text" value="<?php echo $row['vis_exD'] ?>" name="vis_exD" class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    <label class="col-sm-3 col-form-label">Upload Visa Attachment</label>
                                                    <div class="col-sm-9">
                                                    <img src="<?php echo $upload_dir . $row['vis_doc'] ?>" width="100">
                                                        <input type="file" name="vis_doc" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
