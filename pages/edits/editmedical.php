...
if (isset($_GET['med_sml'])) {
  $med_sml = $_GET['med_sml'];
...
if (isset($_POST['Submit'])) {
  ...
  if (!isset($errorMsg)) {
    $sql = "update medical
				set med_issD = '" . $med_issD . "',
                med_prob = '" . $med_prob . "',
                med_pasGar = '" . $med_pasGar . "',
                med_comGar = '" . $med_comGar . "',
                med_recD = '" . $med_recD . "'
					where med_sml=" . $med_sml;
    $result = mysqli_query($conn, $sql);
    if ($result) {
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-description">Edit Medical Details</h4>
                  <br>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                            <input type="text" value="<?php echo $row['med_sml'] ?>" name="med_sml" class="form-control"/>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                          <input type="text" value="<?php echo $row['med_issD'] ?>" name="med_issD" class="form-control"/>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <input type="text" value="<?php echo $row['med_prob'] ?>" name="med_prob" class="form-control"/>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                          <input type="text" value="<?php echo $row['med_pasGar'] ?>" name="med_pasGar" class="form-control"/>                          
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                          <img src="<?php echo $upload_dir . $row['med_pasAtt'] ?>" width="100">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                          <input type="text" value="<?php echo $row['med_comGar'] ?>" name="med_comGar" class="form-control"/>                          
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-4 col-form-label">Upload Attachment</label>
                          <div class="col-sm-8">
                          <img src="<?php echo $upload_dir . $row['med_comAtt'] ?>" width="100">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                          <input type="text" value="<?php echo $row['med_recD'] ?>" name="med_recD" class="form-control"/>                          
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <img src="<?php echo $upload_dir . $row['med_doc'] ?>" width="100">
