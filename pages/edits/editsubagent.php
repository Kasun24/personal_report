...
if (isset($_GET['sub_sml'])) {
  $sub_sml = $_GET['sub_sml'];
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              ...
              <li class="nav-item"><a class="nav-link" href="../tables/clients.php">Personal Info</a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="../tables/subagent.php">Sub Agent<br>Details</a></li>              </ul>
            </div>
          </li>
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-description">Edit Sub Agent Details</h4>
                  <br>
                  <form class="form-sample" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                            <input type="text" value="<?php echo $row['sub_sml'] ?>" name="sub_sml" class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-6 col-form-label">Sub Agent Code</label>
                          <div class="col-sm-6">
                          <input type="text" value="<?php echo $row['sub_code'] ?>" name="sub_code" class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Sub Agent Name</label>
                          <div class="col-sm-9">
                          <input type="text" value="<?php echo $row['sub_name'] ?>" name="sub_name" class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Sub Agent Address</label>
                          <div class="col-sm-9">
                            <input type="text" value="<?php echo $row['sub_addr'] ?>" name="sub_addr" class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-6 col-form-label">Sub Agent Contact No 1</label>
                          <div class="col-sm-6">
                          <input type="text" value="<?php echo $row['sub_cont1'] ?>" name="sub_cont1" class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-6 col-form-label">Sub Agent Contact No 2</label>
                          <div class="col-sm-6">
                          <input type="text" value="<?php echo $row['sub_cont2'] ?>" name="sub_cont2" class="form-control">
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-6 col-form-label">Sub Agent ID No</label>
                          <div class="col-sm-6">
                          <input type="text" value="<?php echo $row['sub_id'] ?>" name="sub_id" class="form-control">
                          </div>
                        </div>
                      </div>
                    </div>
