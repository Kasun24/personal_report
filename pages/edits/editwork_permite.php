...
if (isset($_GET['wor_sml'])) {
  $wor_sml = $_GET['wor_sml'];
...
if (isset($_POST['Submit'])) {
  ...
  if (!isset($errorMsg)) {
    $sql = "update work_permite
				set wor_recD = '" . $wor_recD . "',
                wor_perNo = '" . $wor_perNo . "',
                wor_type = '" . $wor_type . "',
                wor_valD = '" . $wor_valD . "'
					where wor_sml=" . $wor_sml;
    $result = mysqli_query($conn, $sql);
    if ($result) {
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-description">Edit Work Permit Details</h4>
                  <br>
                  <form class="form-sample" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                            <input type="text" value="<?php echo $row['wor_sml'] ?>" name="wor_sml" class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-6 col-form-label">Recieved Date</label>
                          <div class="col-sm-6">
                          <input type="text" value="<?php echo $row['wor_recD'] ?>" name="wor_recD" class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-6 col-form-label">Work Permit No</label>
                          <div class="col-sm-6">
                          <input type="text" value="<?php echo $row['wor_perNo'] ?>" name="wor_perNo" class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <input type="text" value="<?php echo $row['wor_type'] ?>" name="wor_type" class="form-control"/>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                          <input type="text" value="<?php echo $row['wor_valD'] ?>" name="wor_valD" class="form-control" />                          
                          </div>
                        </div>
                      </div>
                    </div>
