...
if (isset($_GET['apSMLNo'])) {
  $apSMLNo = $_GET['apSMLNo'];
...
if (isset($_POST['Submit'])) {
  ...
  if (!isset($errorMsg)) {
    $sql = "update area_police
									set apName = '" . $apName . "',
                  apDID = '" . $apDID . "',
                  apProb = '" . $apProb . "',
                  apRecD = '" . $apRecD . "'   
					where apSMLNo=" . $apSMLNo;
    $result = mysqli_query($conn, $sql);
    if ($result) {
      $successMsg = 'New record updated successfully';
      header('Location:../tables/police1.php');
    } else {
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-description">Edit Area Police Report Details</h4>
                  <br>
                  <form class="form-sample" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                            <input type="text" value="<?php echo $row['apSMLNo'] ?>" name="apSMLNo" class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Area Police Name </label>
                          <div class="col-sm-9">
                          <input type="text" value="<?php echo $row['apName'] ?>" name="apName" class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-6 col-form-label">Document Issued Date</label>
                          <div class="col-sm-6">
                          <input type="text" value="<?php echo $row['apDID'] ?>" name="apDID" class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">If Any Police Problem<br>(Describe It)</label>
                          <div class="col-sm-9">
                            <input type="text" value="<?php echo $row['apProb'] ?>" name="apProb" class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-6 col-form-label">Police Report Recived Date</label>
                          <div class="col-sm-6">
                          <input type="text" value="<?php echo $row['apRecD'] ?>" name="apRecD" class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <img src="<?php echo $upload_dir . $row['apDoc'] ?>" width="100">
                          <input type="file" name="apDoc" class="form-control">
                          </div>
                        </div>
                      </div>
                    </div>
