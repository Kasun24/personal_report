...
if (isset($_GET['hqSMLNo'])) {
  $hqSMLNo = $_GET['hqSMLNo'];
...
if (isset($_POST['Submit'])) {
  ...
  if (!isset($errorMsg)) {
    $sql = "update head_police
				set hqApplyD = '" . $hqApplyD . "',
                hqRefNo = '" . $hqRefNo . "',
                hqProb = '" . $hqProb . "',
                hqRecD = '" . $hqRecD . "'   
					where hqSMLNo=" . $hqSMLNo;
    $result = mysqli_query($conn, $sql);
    if ($result) {
      $successMsg = 'New record updated successfully';
      header('Location:../tables/police2.php');
    } else {
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-description">Edit Head Quarters Police Report Details</h4>
                  <br>
                  <form class="form-sample" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                            <input type="text" value="<?php echo $row['hqSMLNo'] ?>" name="hqSMLNo" class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <input type="text" value="<?php echo $row['hqApplyD'] ?>" name="hqApplyD" class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-6 col-form-label">Apply Reference No</label>
                          <div class="col-sm-6">
                          <input type="text" value="<?php echo $row['hqRefNo'] ?>" name="hqRefNo" class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" value="<?php echo $row['hqProb'] ?>" name="hqProb" class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                          <input type="text" value="<?php echo $row['hqRecD'] ?>" name="hqRecD" class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                          <img src="<?php echo $upload_dir . $row['hqDoc'] ?>" width="100">
                          <input type="file" name="hqDoc" class="form-control">
                          </div>
                        </div>
                      </div>
                    </div>
