...
if (isset($_GET['delete'])) {
    $wor_sml = $_GET['delete'];
    $sql = "select * from work_permite where wor_sml = " . $wor_sml;
    $result = mysqli_query($conn, $sql);
    if (mysqli_num_rows($result) > 0) {
        $row = mysqli_fetch_assoc($result);
        $sql = "delete from work_permite where wor_sml=" . $wor_sml;
        if (mysqli_query($conn, $sql)) {
            header('location:work_permite.php');
        }
    }
}
?>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                ...
                <div class="content-wrapper">
                    <h4 align="center">Work Permit Details Table</h4>
                    <br>
                    <table id="example" class="table table-fixed table-bordered table-responsive table-hover" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th width="20%" style="padding:10px">Recieved Date</th>
                                <th width="20%" style="padding:10px">Work Permit No</th>
                                <th width="35%" style="padding:10px">Work Type</th>
                                <th width="10%" style="padding:10px">Valid Date</th>
                        ...
                        <tbody>
                            <?php
                            $sql = "select * from work_permite";
                            $result = mysqli_query($conn, $sql);
                            if (mysqli_num_rows($result)) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ?>
                                    <tr>
                                        <td width="15%" style="padding:10px"><?php echo $row['wor_sml'] ?></td>
                                        <td width="20%" style="padding:10px"><?php echo $row['wor_recD'] ?></td>
                                        <td width="20%" style="padding:10px"><?php echo $row['wor_perNo'] ?></td>
                                        <td width="35%" style="padding:10px"><?php echo $row['wor_type'] ?></td> 
                                        <td width="10%" style="padding:10px"><?php echo $row['wor_valD'] ?></td> 
                                        <td width="10%" style="padding:10px">                                  
                                            <a href="work_permite.php?delete=<?php echo $row['wor_sml'] ?>" class="btn btn-danger" style="padding: 5px 10px;" onclick="return confirm('Are you sure to delete this record?')">Delete</a><br>
                                            <a href="../edits/editwork_permite.php?wor_sml=<?php echo $row['wor_sml'] ?>" style="padding: 5px 10px;"   class="btn btn-warning">Edit</a>
                                        </td>
                                    </tr>
                            <?php
                                }
