...
if (isset($_GET['delete'])) {
    $vis_sml = $_GET['delete'];
    $sql = "select * from visa where vis_sml = " . $vis_sml;
    $result = mysqli_query($conn, $sql);
    if (mysqli_num_rows($result) > 0) {
        $row = mysqli_fetch_assoc($result);
        $vis_doc = $row['vis_doc'];
        unlink($upload_dir . $vis_doc);

        $sql = "delete from visa where vis_sml=" . $vis_sml;
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                ...
                <div class="content-wrapper">
                    <h4 align="center">Visa Details Table</h4>
                    <br>
                    <table id="example" class="table table-fixed table-bordered table-responsive table-hover" style="width:100%">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th width="15%" style="padding:10px">Visa Issued<br>Date</th>
                                <th width="30%" style="padding:10px">Visa Type</th>
                                <th width="30%" style="padding:10px">Country</th>
                                <th width="15%" style="padding:10px">Visa Expire<br>Date</th>
                                <th width="15%" style="padding:10px">Attachment</th>
                                <th width="15%" style="padding:10px">Action</th>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            ...
                            if (mysqli_num_rows($result)) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ?>
                                    <tr>
                                        <td width="15%" style="padding:10px"><?php echo $row['vis_sml'] ?></td>
                                        <td width="15%" style="padding:10px"><?php echo $row['vis_issD'] ?></td>
                                        <td width="30%" style="padding:10px"><?php echo $row['vis_type'] ?></td>
                                        <td width="30%" style="padding:10px"><?php echo $row['vis_cntr'] ?></td>
                                        <td width="15%" style="padding:10px"><?php echo $row['vis_exD'] ?></td>
                                        <td width="15%"><a href="<?php echo $upload_dir . $row['vis_doc'] ?>"><img src="<?php echo $upload_dir . $row['vis_doc'] ?>" style="border-radius: 0%;"></a></td>
                                        <td width="15%" class="text-center" style="padding:10px">
                                            <a href="visa.php?delete=<?php echo $row['vis_sml'] ?>" class="btn btn-danger" style="padding: 5px 10px;" onclick="return confirm('Are you sure to delete this record?')">Delete</a><br>
                                            <a href="../edits/editvisa.php?vis_sml=<?php echo $row['vis_sml'] ?>" style="padding: 5px 10px;"   class="btn btn-warning">Edit</a>
                                        </td>
                                    </tr>
                            <?php
                                }
