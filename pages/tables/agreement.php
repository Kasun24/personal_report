...
if (isset($_GET['delete'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $agr_agrDoc = $row['agr_agrDoc'];
        unlink($upload_dir . $agr_agrDoc);

        $sql = "delete from agreement where agr_sml=" . $agr_sml;
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                ...
                <div class="content-wrapper">
                    <h4 align="center">Agreement Details Table</h4>
                    <br>
                    <table id="example" class="table table-fixed table-bordered table-responsive table-hover" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th width="15%" style="padding:10px">Company<br>Name</th>
                                <th width="10%" style="padding:10px">Country</th>
                                <th width="10%" style="padding:10px">Apply Job</th>
                                <th width="5%" style="padding:10px">Basic<br>Salary</th>
                                <th width="5%" style="padding:10px">Allowance</th>
                                <th width="5%" style="padding:10px">OT<br>hours</th>
                                <th width="15%" style="padding:10px">Food</th>
                                <th width="15%" style="padding:10px">Accomodation</th>
                                <th width="5%" style="padding:10px">Sign<br>Date</th>
                                <th width="5%" style="padding:10px">Document</th>
                        ...
                        <tbody>
                            ...
                            if (mysqli_num_rows($result)) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ?>
                                    <tr>
                                        <td width="5%" style="padding:10px"><?php echo $row['agr_sml'] ?></td>
                                        <td width="15%" style="padding:10px"><?php echo $row['agr_comp'] ?></td>
                                        <td width="10%" style="padding:10px"><?php echo $row['agr_country'] ?></td>
                                        <td width="10%" style="padding:10px"><?php echo $row['agr_job'] ?></td>
                                        <td width="5%" style="padding:10px"><?php echo $row['agr_sal'] ?></td>
                                        <td width="5%" style="padding:10px"><?php echo $row['agr_allaw'] ?></td>
                                        <td width="5%" style="padding:10px"><?php echo $row['agr_ot'] ?></td>
                                        <td width="15%" style="padding:10px"><?php echo $row['agr_food'] ?></td>
                                        <td width="15%" style="padding:10px"><?php echo $row['agr_acco'] ?></td>
                                        <td width="5%" style="padding:10px"><?php echo $row['agr_signD'] ?></td>
                                        <td width="5%"><a href="<?php echo $upload_dir . $row['agr_agrDoc'] ?>"><img src="<?php echo $upload_dir . $row['agr_agrDoc'] ?>" style="border-radius: 0%;"></a></td>
                                        <td width="5%" style="padding:10px">
                                            <a href="agreement.php?delete=<?php echo $row['agr_sml'] ?>" class="btn btn-danger" style="padding: 5px 10px;" onclick="return confirm('Are you sure to delete this record?')">Delete</a><br>
                                            <a href="../edits/editagreement.php?agr_sml=<?php echo $row['agr_sml'] ?>" style="padding: 5px 10px;" class="btn btn-warning">Edit</a>
                                        </td>
                                    </tr>
                            <?php
                                }
